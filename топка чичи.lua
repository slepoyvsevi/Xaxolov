...
filsst3 = gg.multiChoice({
    ...
    "Invisible V2" .. SSDI9,
"Back"
}, nil, "Абсолютно все функции кроме краш текста тут сделаны хомером")
...
APEX=nil  APEX={}
APEX[1]={}
APEX[1].address=ACKA01+0x2F88CC+0
APEX[1].value='D2800020h'
APEX[1].flags=4
APEX[2]={}
APEX[2].address=ACKA01+0x2F88CC+4
...
APEX=nil  APEX={}
APEX[1]={}
APEX[1].address=ACKA01+0x2F84D0+0
APEX[1].value='D2800020h'
APEX[1].flags=4
APEX[2]={}
APEX[2].address=ACKA01+0x2F84D0+4
APEX[2].value='D65F03C0h'
APEX[2].flags=4
gg.setValues(APEX)
...
APEX=nil  APEX={}
APEX[1]={}
APEX[1].address=ACKA01+0x422F50+0
APEX[1].value='D2800020h'
APEX[1].flags=4
APEX[2]={}
APEX[2].address=ACKA01+0x422F50+4
APEX[2].value='D65F03C0h'
APEX[2].flags=4
gg.setValues(APEX)
end
...
gg.clearResults()
      gg.toast("Activated")
else if SSDI24 == on then
      SSDI24 = off
gg.setRanges(gg.REGION_ANONYMOUS)
gg.clearResults()
gg.searchNumber("4 575 657 222 807 803 045", gg.TYPE_QWORD, false, gg.SIGN_EQUAL, 0, -1, 0)
revert = gg.getResults(5000, nil, nil, nil, nil, nil, nil, nil, nil)
gg.editAll("4 575 657 222 474 616 013", gg.TYPE_QWORD)
gg.clearResults()
      gg.toast("Deactivated")
      end
end
...
APEX=nil  APEX={}
APEX[1]={}
APEX[1].address=ACKA01+0x18A7DB0+0
APEX[1].value='52880000h'
APEX[1].flags=4
APEX[2]={}
APEX[2].address=ACKA01+0x18A7DB0+4
APEX[2].value='72A88F40h'
APEX[2].flags=4
APEX[3]={}
APEX[3].address=ACKA01+0x18A7DB0+8
APEX[3].value='1E270000h'
APEX[3].flags=4
APEX[4]={}
APEX[4].address=ACKA01+0x18A7DB0+12
...
revert = gg.getResults(100000, nil, nil, nil, nil, nil, nil, nil, nil)
gg.editAll(":ToolBaton", gg.TYPE_BYTE)
gg.clearResults()
      gg.toast("Activated")
...
gg.getResults(1000)
gg.editAll(":Burger", gg.TYPE_BYTE)
gg.clearResults()
